...
PRESET_SUMMARIES: Final[dict[str, str]] = {
    ...
    "local_cpu": "Package-managed local CPU road with NLLB, local embeddings, and GGUF labeling by default.",
    "local_gpu": "Package-managed local GPU road with local Transformers translation and labeling by default.",
}
